...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    MatchParen     { bg = main_color, fg = black }, -- Character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
    ...
    FloatTitle     { fg = main_color }, -- Title of floating windows.
    ...
    Search         { bg = main_color, fg = black }, -- Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
    ...
    Title          { fg = main_color }, -- Titles for output from ":set all", ":autocmd" etc.
    ...
    PreProc        { fg = warning }, -- (*) Generic Preprocessor
    ...
    Special        { fg = main_color }, -- (*) Any special symbol
    ...
    Underlined     { fg = main_color.darken(50), gui = "underline" }, -- Text that stands out, HTML links
    -- Ignore         { }, -- Left blank, hidden |hl-Ignore| (NOTE: May be invisible here in template)
    Error          { fg = error }, -- Any erroneous construct
    Todo           { bg = main_color, fg = black }, -- Anything that needs extra attention; mostly the keywords TODO FIXME and XXX
